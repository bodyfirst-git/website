document.addEventListener("DOMContentLoaded", () => {
  ...
  // const scrollCustom = document.getElementById("how-we-stand-out-inner");
  // const leftIcon = document.getElementsByTagName(".scrollLeft i");

  // const rightIcon = document.getElementsByTagName(".scrollRight i");
